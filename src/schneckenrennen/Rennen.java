...
public class Rennen {
    ...
    /**
     * Indicates if the race has already ended. A race can't be continued if
    ...
    /**
     * Lets all of the snails creep forward as far as they can.
     * If the race ends during the execution of this method, the snails will
     * be sorted so the winner is the first one on the list.
     * Does nothing if the race isn't running.
     */
